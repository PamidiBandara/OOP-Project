    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.GET, "/authors", "/publishers", "/brands").permitAll()
                        .requestMatchers(HttpMethod.GET, "/offers", "/announcements").permitAll()
                        .requestMatchers(HttpMethod.GET, "/studykits").permitAll()
